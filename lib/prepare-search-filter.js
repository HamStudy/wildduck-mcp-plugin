...
// This file is copied from WildDuck's lib/prepare-search-filter.js
// Source: https://github.com/nodemailer/wildduck/blob/master/lib/prepare-search-filter.js
// Copyright (c) 2017-2024 Zone Media OÜ
// Licensed under the European Union Public License 1.2 (EUPL-1.2)
// 
// This is a direct copy to avoid importing from outside the plugin directory
// Any updates to the original should be reflected here

const ObjectId = require('mongodb').ObjectId;

// We need to copy escapeRegexStr from tools.js as well
